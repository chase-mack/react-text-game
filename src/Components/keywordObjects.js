const destinations = {
    foyer: {
        ...
        back: 'You see the garage door, stairs leading up, and the living room.'
    },
    living: {
        back: 'You see the foyer, a set of stairs leading down, and the kitchen.'
    },
    up: {
        ...
        back: 'You return to the living room. The kitchen is to the right. The left, the foyer.'
    },
    bedroom: {
    ...
    office: {
        ...
        back: 'You are back in the office.'
    },
    kitchen: {
        ...
        back: 'You see the door to the office and the living room.'
    },
    garage: {
        ...
        back: 'Maybe there is something else under all of this junk?',
    ...
    basement: {
        ...
        back: 'You return to apprectiate the sports memorabilia.',
